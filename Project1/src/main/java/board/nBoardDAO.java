	...
	//멤버변수 
		...
		public int getMaxnum() {
			...
			try {
				...
				String sql = "select max(num) from nboard";
		...
		public void insertBoard(BoardDTO bDTO) {
			try {
				...
				String sql="insert into nboard(num, name, pass, subject, content, readcount, date, file) values(?,?,?,?,?,?,?,?)";
				pstmt=con.prepareStatement(sql);
		...
		public List getBoardList(int startRow, int pageSize) {
			...
			try {
				...
				String sql = "select * from nboard order by num desc limit ?,?";
				pstmt=con.prepareStatement(sql);
		...
		public BoardDTO getBoard(int num) {
			...
			try {
				...
				String sql = "select * from nboard where num=?";
				pstmt=con.prepareStatement(sql);
				pstmt.setInt(1, num);
		...
		public void updateReadcount(int num) {
			try {
				...
				String sql = "update nboard set readcount=readcount+1 where num=?";
				pstmt=con.prepareStatement(sql);
				pstmt.setInt(1, num);
		...
		public BoardDTO numCheck(int num, String pass) {
			...
			try {
				...
				String sql = "select * from nboard where num=? and pass=?";
				pstmt=con.prepareStatement(sql);
				pstmt.setInt(1, num);
		...
		public void updateBoard(BoardDTO updateDTO) {
			try {
				...
				String sql = "update nboard set subject=?, content=?, file=? where num=?";
				pstmt=con.prepareStatement(sql);
		...
		public void deleteBoard(int num) {
			try {
				...
				String sql = "delete from nboard where num=?";
				pstmt=con.prepareStatement(sql);
				pstmt.setInt(1, num);
